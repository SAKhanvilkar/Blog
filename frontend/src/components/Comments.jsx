  ...
  return (
    <div className='flex flex-col gap-8 lg:w-3/5 mb-12'>
        ...
        <form onSubmit={handleSubmit} className='flex items-center justify-between gap-8 w-full'>
            <textarea placeholder='write a comment...' className='w-full p-4 rounded-xl' name="desc"></textarea>
            <button className='bg-blue-800 rounded-xl font-medium px-4 py-3 text-white'>Send</button>
        </form>
        {isPending ? (
        "Loading..."
      ) : error ? (
